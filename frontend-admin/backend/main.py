...
async def ai_draft(req: AIDraftRequest):
    ...
    system = """You are the editorial AI for Vide Verum, a credible UAP/UFO encyclopedia. 
Your job is to draft factual, sourced encyclopedia entries about documented UAP encounters.
Be precise, specific, and factual. Never speculate. Use military/government terminology.
Always include real, verifiable source URLs where you know them with high confidence.
Flag anything you are less than 90% confident about in verify_flags."""
...
{{
  ...
  "narrative": "4-5 paragraphs. Factual, documented. What happened, who witnessed it, official response, what remains unexplained. No editorializing.",
  "credibility_score": 4,
